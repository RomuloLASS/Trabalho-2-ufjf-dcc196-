...
public class PlanejamentosContract {
    public static class Planejamentos implements BaseColumns{
        ...
        public static final String CREATE_TABLE = String.format("CREATE TABLE %s (%s INTEGER PRIMARY KEY AUTOINCREMENT , %s TEXT, %s TEXT, %s INTEGER)", TABLE_NAME, _ID, COLLUMN_ANO, COLLUMN_SEMESTRE, COLLUMN_HORAS, COLLUMN_LINGUAS, COLLUMN_HUMANAS, COLLUMN_EXATAS, COLLUMN_SAUDE);
